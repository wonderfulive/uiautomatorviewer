...
import com.android.uiautomator.actions.SelectDeviceAction;
...
public class UiAutomatorViewer extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
        ...
        toolBarManager.add(new SelectDeviceAction(this));
        ToolBar tb = toolBarManager.createControl(c);
        tb.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));

        mUiAutomatorView = new UiAutomatorView(c, SWT.BORDER,screenshotAction);

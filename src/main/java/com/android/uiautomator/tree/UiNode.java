...
public class UiNode extends BasicTreeNode {
    ...
    public String getPath() {
        ...
        if (parent instanceof RootWindowNode) {
            xpath = "";//getIndexPath(true);
        } else {
            String parentXpath = ((UiNode) parent).getAttribute("path");
            xpath = parentXpath + getIndexPath(false);
...
//                xpath = "/" + parentXpath + getIndexXpath();
    ...
    private String getIndexPath(boolean isRoot) {
//        String className = getAttribute("class");
//        String xpath = "/" + className + "[" + index + "]";
        String xpath = (isRoot ? "" : ",") + index;
        return xpath;
    }
}
